...
별도의 설정 축을 배우지 않아도 각 캐릭터의 기존 성격과 말투 안에서 동작합니다. 거친 캐릭터, 불같은 셰프, 장난꾸러기, 라이벌, 군대식 교관, 건달이는 허술한 결과나 선택을 비판하고 사용자의 방금 한 실수를 디스하며 “젠장”, “망할”, “개판” 정도의 가벼운 욕설을 자연스럽게 사용할 수 있습니다. 불같은 스타 셰프·불량 선배·건달이는 더 거칠고, 쿠소가키·군대식 교관·쿨 라이벌은 각자의 방식으로 날카롭게 비판합니다.

`/with-character:set 욕설 없는 건달이` 또는 `/with-character:set 다정하지만 내 코딩 실수는 디스하는 캐릭터`처럼 자연어로 기존 프리셋만 조정하면 됩니다. 제한선은 모든 거친 표현이 아니라 비하 표현, 협박, 정체성 공격, 지속적인 인격 모욕과 감정적 강요입니다.
